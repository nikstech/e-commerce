...
import { isAdmin } from "src/shared/helper/isAdmin";
...
const Navbar = () => {
  ...
  const isNavbarHamburgurOpen = useSelector(
    state => state.layout.navbarHamburgur
  );
  dispatch(loginSignupModalToggle(false));

  const navbarToggleOpen = () => {
    if (isNavbarHamburgurOpen) {
      dispatch(hamburgerrToggle(false));
    } else {
      dispatch(hamburgerrToggle(true));
    }
  };
      ...
      <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          {isAuth ? (
            <>
              ...
              >
                ...
                <div className="userDropdown absolute right-0 top-0 mt-5 bg-gray-200 rounded">
                  {!isAdmin() ? (
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <span className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer">
              Shop
            </span>
            <span className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer">
              Blog
