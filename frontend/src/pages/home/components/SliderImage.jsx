...
import { getSlideImage } from "../apiCall/slide";
import { nextSlide } from "../helper/nextSlide";
import { previousSlide } from "../helper/previousSlide";
...
const SliderImage = () => {
  ...
  let totalSlides = sliderImages.length;
  return (
    <>
      <div className="relative mt-16 bg-gray-100 border-2">
        ...
        <>
          <svg
            onClick={() => previousSlide(totalSlides, slide, setSlide)}
